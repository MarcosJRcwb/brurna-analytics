...
![Distribuição de Duração](docs/img/comparison_duration.png)
![Adesão por Modelo](docs/img/comparison_models.png)

## 📊 Seção III: Especialista Estatístico (Fluxos)

### Densidade Temporal (Ocupação horária)
![Fluxo Temporal](docs/img/comparison_temporal.png)

### Volume Comparado
![Volume de Dados](docs/img/comparison_volume.png)
